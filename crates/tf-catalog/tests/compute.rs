...
impl Fixture {
    fn new() -> Self {
        ...
        let definition = json!({"module":"output","function":"produce","path":"src/output.py","line":1,"source":false,"engine":"polars","inputs":[{"alias":"rows","ref":{"form":"string","value":"raw/input"},"branch":{"kind":"omitted","name":null},"stop_branch_fallback":false,"role":"data","checks":[]}],"output":{"ref":{"form":"string","value":"curated/output"},"schema":null,"checks":[{"id":"key","name":"Key","expectation":{"ast_version":1,"kind":"non_null","columns":["id"]},"on_error":"FAIL","null_policy":null,"sample_rows":null,"description":null}]},"parameters":[{"name":"limit","logical_type":{"type":"i64"},"default":{"type":"i64","value":"1"}}],"wall_timeout_seconds":null,"cache":"deterministic","refresh":null,"secret_refs":[],"lineage_json":null});
        let inputs = vec![
