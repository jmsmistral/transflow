...
The spec repository is a development requirement, not a runtime dependency of the installed application. The current baseline is specification **1.1.0**; consult its change history before implementing a superseded design.
