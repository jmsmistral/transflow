...
"$python_bin" -m ruff check --config python/pyproject.toml python tools/safety tools/qualification/duckdb tools/qualification/resources
"$python_bin" -m ruff format --config python/pyproject.toml --check python tools/safety tools/qualification/duckdb tools/qualification/resources
